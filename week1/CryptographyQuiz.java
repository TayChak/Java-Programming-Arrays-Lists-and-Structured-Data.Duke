...
public class CryptographyQuiz {
	...
	public static void main(String[] args) {
		...
		System.out.println("Ques 1 :"+o1.encrypt("Can you imagine life WITHOUT the internet AND computers in your pocket?"));
		System.out.println("------------------------------------------------");
		// Question 2
		...
		System.out.println("Ques4: "+w.indexOfMax(counts) +"\n");
		...
		w.countWordLengths(resource, counts);
		System.out.println("Ques5: "+w.indexOfMax(counts));
		...
		System.out.println("\n" +"Ques6: "+ o3.decrypt("Hfs cpwewloj loks cd Hoto kyg Cyy."));
        ...
        System.out.println("Ques8: "+cc.encryptTwoKeys(message, 26-key1, 26-key2));
